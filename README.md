...
A. Semantic Html gives each section meaning
2. Name two big differences between ```display: block;``` and ```display: inline;```.
A. with display: block, a line break happens after the element.
...
git gives you a way protect your work in the cloud. It also lets you colabarate without mixing up the project with different useres. it lets you decide whiich one to commit
